.PHONY: help test lint fix typecheck lint-imports check coverage smoke
...
help:
	...
	@echo "make lint-imports — check import layering contracts"
...
check: test lint typecheck lint-imports
