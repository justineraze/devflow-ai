...
class TestComplexityScore:
    ...
    def test_workflow_quick_at_boundary(self) -> None:
        # Bornes (1, 4, 7, 12): total=1 is the upper bound of quick.
    ...
    def test_workflow_light_at_boundary(self) -> None:
        # total=4 is the upper bound of light under the new bornes.
        score = ComplexityScore(files_touched=2, integrations=1, security=1, scope=0)
        assert score.total == 4
        assert score.workflow == "light"
    ...
    def test_workflow_standard_at_boundary(self) -> None:
        # total=7 is the upper bound of standard under the new bornes.
        score = ComplexityScore(files_touched=2, integrations=2, security=2, scope=1)
