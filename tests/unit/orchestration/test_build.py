...
class TestFinalizeBuildCacheWarning:
    ...
    def test_warns_when_cache_hit_rate_low(
        ...
        finalize_build(feature, "feat/test", totals, [], callbacks, project_dir)
...
class TestAutoCommitAfterPhase:
    ...
    @patch("devflow.orchestration.phase_handlers.git_status_porcelain", return_value=" M f")
    ...
    @patch("devflow.orchestration.execution._execute_phase", return_value=_PHASE_OK)
